...
class Photos {
  ...
  factory Photos.fromJson(Map<String, dynamic> json) {
    return Photos(
      ...
      authorAttributions: json['authorAttributions'] != null ? (json['authorAttributions'] as List).map((i) => AuthorAttributions.fromJson(i)).toList() : [],
    );
  }
}
...
EditorialSummary copyWith({  required String text,
  required String languageCode,
...
class DisplayName {
  ...
  String _text = "";
  String _languageCode="";
DisplayName copyWith({  required String text,
  required String languageCode,
